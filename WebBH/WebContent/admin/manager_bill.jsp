										...
										<table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                                    		<thead>
                                    			<tr role="row">
                                        			...
                                        			<th class="sorting" tabindex="0"  aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Bill_ID : activate to sort column ascending" style="width: 157px;"> Bill_ID </th>
                                        			<th class="sorting" tabindex="0"  aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" User ID : activate to sort column ascending" style="width: 237px;"> User ID </th>
                                        			<th class="sorting" tabindex="0"  aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Address : activate to sort column ascending" style="width: 114px;"> Address </th>
                                        			<th class="sorting" tabindex="0"  aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Payment : activate to sort column ascending" style="width: 114px;"> Payment </th>
                                        			<th class="sorting" tabindex="0"  aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Date buy : activate to sort column ascending" style="width: 114px;"> Date buy </th>
										...
										%>                                         
                                   			<tr class="gradeX odd" role="row">
                                 				<td  width="30px"> <%=count%></td>
                                 	 	 		...
                                 	 	 		<td> <%=bill.getDate_buy()%></td>
                                 	 	 		<td> <%=bill.getBill_status()%></td>
                          	         			<td>
												<div class="btn-group">
                        							...
                        							<ul class="dropdown-menu" role="menu">
                                                		<li>	
                                                    		<a href="/WebBH/admin/bill_details.jsp">
                                           	        		<i class="icon-user"></i> Details </a>
                                            	        </li>

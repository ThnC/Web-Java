...
<div class="col-md-4">
	<div id="rightContent">
                    <h3>Add product</h3>
						<div="portlet-body">
                        	<form role="form" action="/WebBH/ManagerProductServlet" method="post" enctype="multipart/form-data">
                            	<div class="form-group">
                               		<label class="control-label">Product name</label>
                                    <input type="text" placeholder="Name of product" class="form-control" name="product_name"><%=error%>
                                </div>
                                ...
                                <div class="form-group mt-repeater">
                              	...
                              	<div class="form-group">
                                    	...
                                    	<select id="select2-single-input-lg" name="category_id" class="form-control input-lg select2-multiple" dir="rtl">
                                    	<% for(Category c : CategoryDAOImpl.getListCategoryCha()){ %>
                                	<optgroup label="<%=c.getCategory_name() %>" >
                                	<%for(Category cc : CategoryDAOImpl.getListCategoryCon(c.getCategory_id())){ %>
                                		<option value="<%=cc.getCategory_id()%>"><%= cc.getCategory_name() %></option>
                                		<%} %>
                                    </optgroup>                
	                                <%} %>                         
                                  		</select>
                              	...
                              	<div class="form-group">
                                        ...
                                        <input type="text" placeholder="Quantity" class="form-control" style="width: 100dx;" name="product_quantity"><%=error%>
                                </div>
                                                
                              	<div class="form-group">
                                	<label class="control-label">Product Description</label>
                                    	<textarea class="form-control" rows="About product" placeholder="It's delicious!!" name="product_description"><%=error%></textarea>
                                </div>
                                <div class="form-group">
                                	<label class="control-label">Price</label>
                                	<input type="text" placeholder="Price" class="form-control" name="pro_price"><%=error%>
                                </div>
